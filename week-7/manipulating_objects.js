...
// I had trouble understanding adding properties to terms that were already defined. I wasn't thinking
// about how the same properties could be applied to the same things. This exercise illustrated that
// by showing that two things can share the same property (terah and adam being spouses of one another here).

// How difficult was it to add and delete properties outside of the object itself?
// Fairly easy once I got the hang of it. Deleting properties seems as straightforward 
// What did you learn about manipulating objects in this challenge?
//It seems like I can easily reassign/change values in objects just by renaming them outside. Seems like
// I have too much power. Perhaps there's a way to prevent this from happening too easily in JS.
//
//
//
